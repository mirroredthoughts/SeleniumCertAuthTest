...
@CucumberOptions(
        features= {"src/test/resources/cucumber/Login.feature"},
        glue= {"com/abn/steps/"},
        tags= "@Login",
        monochrome = true,
        plugin = {"json:target/cucumber-report-login-feature.json"}
)
public class RunCukesByLoginFeature extends BaseStepDefs {
